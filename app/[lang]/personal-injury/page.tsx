...
<div className="mt-[400px] md:container md:mx-auto md:pl-[130px] md:pr-[130px]">
      <p className="mt-[400px] text-4xl tracking-wide w-full border-b-4 border-dotted border-logoBlue text-logoBlue p-3">Personal Injury Services:</p>
</div>
...
<div className='grid md:container md:mx-auto md:grid-cols-3 sm:grid-cols-1 gap-x-2 gap-y-3 grid-flow-row-dense pt-10 max-w-[1000px] md:pl-[130px] md:pr-[130px]  '>
      ...
      <div className="flex md:flex-row w-full pt-5 sm:flex-col sm:pl-10 ">
            <div className="flex flex-row md:w-7/8 sm:w-full sm:pr-8">
            <Image className="sm:max-h-[350px] p-6 pt-8 pr-3 sm:pl-1" width={480} height={200} src={carAccident} alt=""/>
            </div>
      ...
      <div className=' bg-logoBlue   shadow-xl min-h-[350px]' />
